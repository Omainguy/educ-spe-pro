        ...
        <div className="min-h-screen bg-slate-50 flex items-center justify-center p-4">
            <div className="max-w-md w-full space-y-8 bg-white p-10 rounded-3xl shadow-xl shadow-slate-200 border border-slate-100 animate-in fade-in zoom-in duration-300">
                    ...
                    <div className="space-y-4">
                        <div className="relative">
                            ...
                            <input
                                ...
                                className="w-full pl-12 pr-4 py-3.5 rounded-xl border border-slate-200 outline-none focus:ring-2 focus:ring-indigo-500 bg-slate-50 focus:bg-white transition-all text-slate-900"
                            />
                        </div>
                        <div className="relative">
                ...
                <p className="text-center text-sm text-slate-500">
                    Pas encore de compte ? <button className="text-indigo-600 font-bold hover:underline" type="button">S'inscrire</button>
                </p>
            </div>
        </div>
    );
