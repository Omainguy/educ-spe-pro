    ...
    <div className="flex min-h-screen bg-slate-50">
      ...
      `}>
        ...
        <div className="absolute bottom-0 w-full p-4 border-t border-slate-100">
          <Link to="/login" className="flex items-center gap-3 px-4 py-3 text-slate-600 hover:text-red-600 rounded-xl hover:bg-red-50 transition-all">
            <LogOut size={20} />
            Déconnexion
          </Link>
        </div>
...
const App: React.FC = () => {
  return (
    <HashRouter>
      <Layout>
        <Routes>
          {/* Default Route handling by Layout wrapper */}
        </Routes>
      </Layout>
    </HashRouter>
  );
